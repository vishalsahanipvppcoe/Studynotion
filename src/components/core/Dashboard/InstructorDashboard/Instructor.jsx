...
export default function Instructor() {
  ...
  const [instructorData, setInstructorData] = useState([])   // ✅ default empty array
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div>
          <div className="my-4 flex flex-col lg:flex-row gap-4 h-auto">
